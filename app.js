...
function animateSlides(){
    ...
    sliders.forEach((slide, index, slides) => {
        ...
        // GSAP
        //we use TIMELINE by introducing the new vairable slideTL, after slideTL.fromTo
        ...
        //added the animation to the scroller
        slideScene = new ScrollMagic.Scene({
            ...
            //Create new scene (new variable - new triggers-new hooks, indicators and controllers)
            pageScene = new ScrollMagic.Scene({
                triggerElement: slide,
                //duration - it ends in the end of the slide(or another trigger) while scrolling
                duration:"100%",
                triggerHook: 0
            })
            .setTween(pageTl)
...
barba.init({
    ...
    transitions:[
        {
            leave({current, next}){
                //current section which we named "container"
                //animation
                let done = this.async();
                //scroll to the top
                window.scrollTo(0,0);
